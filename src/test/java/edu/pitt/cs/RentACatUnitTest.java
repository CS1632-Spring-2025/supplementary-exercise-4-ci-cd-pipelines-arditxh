...
public class RentACatUnitTest {
	...
	public void testGetCatNullNumCats0() throws Exception {
		...
		assertNull("Cat should be null when none are added", cat);
	...
	public void testGetCatNumCats3() throws Exception {
		...
		assertNotNull("Cat 2 should exist", result);
	...
	public void testListCatsNumCats0() {
		// TODO: Fill in
		assertEquals("Empty list should return empty string", "", r.listCats());
	}
	...
	public void testListCatsNumCats3() {
		...
		assertEquals("Should list all available cats", expected, r.listCats());
	}
	...
	public void testRenameFailureNumCats0() {
		// TODO: Fill in
		assertFalse("No cats to rename", r.renameCat(2, "Garfield"));
		assertEquals("Invalid cat ID." + newline, out.toString());
	...
	public void testRenameNumCat3() {
		...
		assertTrue("Should rename cat 2", r.renameCat(2, "Garfield"));
	...
	public void testRentCatNumCats3() {
		...
		assertTrue("Should rent available cat", r.rentCat(2));
		verify(c2).rentCat();
	...
	public void testRentCatFailureNumCats3() {
		...
		assertFalse("Shouldn't rent already rented cat", r.rentCat(2));
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue("Should return rented cat", r.returnCat(2));
		verify(c2).returnCat();
	...
	public void testReturnFailureCatNumCats3() {
		...
		assertFalse("Shouldn't return unrented cat", r.returnCat(2));
