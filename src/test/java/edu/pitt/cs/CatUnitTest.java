...
public class CatUnitTest {
	...
	public void testGetId() {
		// TODO: Fill in
		assertEquals("Expected ID 1", 1, c.getId());
	}
	...
	public void testGetName() {
		// TODO: Fill in
		assertEquals("Expected name Jennyanydots", "Jennyanydots", c.getName());
	}
	...
	public void testGetRented() {
		// TODO: Fill in
		assertFalse("Expected rented to be false", c.getRented());
	...
	public void testRentCat() {
		c.rentCat();
		assertTrue("Expected rented to be true", c.getRented());
	}
	...
	public void testReturnCat() {
		...
		assertTrue("Expected rented to be true", c.getRented());
		c.returnCat();
		assertFalse("Expected rented to be false after returnCat()", c.getRented());
	}
